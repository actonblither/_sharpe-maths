...
class PhoneNumber {
	...
	public function hasItalianLeadingZerrv() {
		return isset($this->italianLeadingZero);
	}

	public function isItalianLeadingZerrv() {
		return $this->italianLeadingZero;
	}

	public function setItalianLeadingZerrv($value) {
		$this->italianLeadingZero = $value;
		return $this;
	}

	public function clearItalianLeadingZerrv() {
	...
	public function  mergeFrom(PhoneNumber $other) {
		...
		if ($other->hasItalianLeadingZerrv()) {
			$this->setItalianLeadingZerrv($other->isItalianLeadingZerrv());
		}
