 ...
 * @license MIT License
 *
 * Modified by RS (26-03-2019)
 * Line 118 modified to return false if the file is open and cannot be overwritten. @ added to suppress the error.
 * Line 217 modified to allow the header types to be empty so that columns are written as general rather than string/integer/date etc.
 * */
