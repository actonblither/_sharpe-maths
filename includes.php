...
define('__s_lib_folder__', $base_folder.'/_stdlib/');
define('__s_app_folder__', $base_folder.'/');
define('__s_app_url__', 'https://sharpe-maths.uk/');
define('__s_lib_url__', 'https://sharpe-maths.uk/_stdlib/');
define('__s_icon_url__', 'https://sharpe-maths.uk/_stdlib/_images/_icons/');
define('__s_applib_url__', __s_lib_url__.'_applib/');
define('__s_app_title__', 'Sharpe-Maths Teaching Guide');
...
include(__s_app_folder__.'_classes/_topics/_class_exposition.php');
