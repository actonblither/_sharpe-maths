...
class _example{
	...
	public function __construct($_tid){
		...
		$this->_list_params['add_new_text'] = 'example';
	...
	public function _build_new_example($_id){
		$_tpl = __s_app_url__.'_classes/_example_template.txt';
		$_page = file_get_contents($_tpl);
		$_page = str_replace('{_id}', $_id, $_page);
